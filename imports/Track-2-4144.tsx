import svgPaths from "./svg-qeyttodpdz";
...
export default function Track() {
  return (
    <div
      className="bg-[#2b2b2b] relative rounded-lg size-full"
      data-name="Track"
    >
      ...
      <div className="absolute border-[#9671ff] border-[1px_4px] border-solid inset-0 pointer-events-none rounded-lg" />
    </div>
  );
}
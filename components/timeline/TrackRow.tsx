...
const TrackRow: React.FC<TrackRowProps> = ({
  ...
  // Check if any groups or clips are selected
  const hasSelectedContent = ungroupedClips.some(clip => clip.selected) || 
    trackGroups.some(group => group.clipIds.some(clipId => 
